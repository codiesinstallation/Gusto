    ...
    <div>
        <div class="row d-flex justify-content-center">
            <div class="col-10">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form @keydown.enter.prevent @submit.prevent="saveChanges">
                            <div
...
export default {
    ...
    data() {
        return {
            ...
            tables: [
                {
                    table: "bills,bill_types,offers,mixins_item_request,mixins_type_stock",
                },
                { table: "customer_pay" },
                { table: "customers,customer_pay" },
                { table: "expenses" },
                { table: "mixins_item_request" },
                { table: "mixins_main_types" },
                { table: "mixins_purchase_bills,purchase_bill_types" },
                { table: "mixins_suppliers" },
                { table: "mixins_type_stock" },
                { table: "Offers" },
                ...
                {
                    table: "types,type_units,offers,mixins_type_stock,mixins_item_request",
                },
                { table: "types_sold_without_balance" },
